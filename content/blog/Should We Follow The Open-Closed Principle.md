...
![The Open-Closed Principle extend behaviors instead of changing them](https://thevaluable.dev/images/2021/open_closed_principle/no_change_but_children.jpg)
> 开闭原则不改变行为，而是拓展行为
